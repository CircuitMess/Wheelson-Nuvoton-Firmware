...
#DEBUG = --debug
AFLAGS =  -l -s 
CFLAGS = -DHEAP_SIZE=250 -I$(INCDIR) -m$(MCU_MODEL) --model-$(MODEL) --out-fmt-ihx --no-xinit-opt $(DEBUG) $(DFOSC) --peep-file tools/peep.def
...
disasm: $(TARGET).hex
	./tools/mcs51-disasm.pl -M N76E616.h -I ./inc -fl -rj -as $(TARGET).hex > $(TARGET).a51
